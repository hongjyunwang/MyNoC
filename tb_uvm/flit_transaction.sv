...
module flit_transaction;
    import uvm_pkg::*;
    `include "uvm_macros.svh"

    // hello_test is a kind of uvm_test
    class flit extends uvm_sequence_item;
        // Register flit_transaction with the UVM factory so UVM can create it by name
       ...
       // sequence controls these — not rand
        ...
        function new(string name = "flit_transaction");
            super.new(name); // constructor of the parent class
        endfunction
